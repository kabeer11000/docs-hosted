...
foreach($words as $word){
    if(strlen($word) >= 4){
        array_push($a, array( strtolower(substr($word, 0, 3)) =>  strtolower($word)));
    }
    else if(strlen($word) >= 3){
        array_push($a, array( strtolower(substr($word, 0, 2)) =>  strtolower($word)));
    }else{
        array_push($a, array( strtolower(substr($word, 0, 1)) =>  strtolower($word)));
